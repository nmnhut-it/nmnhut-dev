...
export default pythonKidsLesson(10, {
  ...
  cells: [
    ...
    { code: starter, label: "kids_robot_demo.py", note: "INPUT: the given mood `calm`. PROCESS: show the mood and send one message. OUTPUT: `mood: calm` and `Robot: I am ready.`.", expectOut: /Robot: I am ready\./ },
    { code: starter, solution, label: "kids_robot_edit.py", note: "Change the mood and message to the excited versions in the solution contract. OUTPUT includes `mood: excited` and `Robot: I am ready to explore!`.", expectOut: /Robot: I am ready to explore!/ },
