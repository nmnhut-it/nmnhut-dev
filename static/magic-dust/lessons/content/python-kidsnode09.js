...
export default pythonKidsLesson(9, {
  ...
  cells: [
    ...
    { code: starter, label: "kids_rhythm_demo.py", note: "INPUT: the preset note list. PROCESS: visit each note in order. OUTPUT: the visible notes `C`, `E`, and `G`.", expectOut: /♪ C/ },
    { code: starter, solution, label: "kids_rhythm_edit.py", note: "Add one final `C` to the song list. PROCESS: run the same loop. OUTPUT: the pattern has four notes and ends on `C`.", expectOut: /♪ C/ },
