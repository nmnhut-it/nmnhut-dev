...
export default pythonKidsLesson(1, {
  ...
  cells: [
    ...
    { code: starter, label: "kids_pixel_face.py", note: "INPUT: the preset `face` grid. PROCESS: send each row and column to `show_pixels()`. OUTPUT: a five-by-five face.", expectOut: /██/ },
    { code: starter, solution, label: "kids_pixel_edit.py", note: "Change the center cell from 1 to 0. INPUT: the preset face grid. PROCESS: assign `face[2][2] = 0`. OUTPUT: the center light is dark.", expectOut: /██/ },
