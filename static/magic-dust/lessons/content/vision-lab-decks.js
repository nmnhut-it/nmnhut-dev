...
export const VISION_LAB_DECKS = Object.freeze({
  ...
  rgb: [
    { tab: "Mô hình", title: "Một hình chữ nhật cũng chỉ là ma trận RGB", lead: "Ảnh có sáu hàng và tám cột. Pixel nền dùng `(30,80,180)`; pixel trong hình chữ nhật dùng `(255,40,40)`.", visual: `<div class="vl-grid-row">${matrix([["B","B","B","B","B","B","B","B"],["B","B","R","R","R","R","B","B"],["B","B","R","R","R","R","B","B"],["B","B","R","R","R","R","B","B"],["B","B","R","R","R","R","B","B"],["B","B","B","B","B","B","B","B"]],{label:"ẢNH 6×8",highlight:[[2,3]]})}${formula("MỘT PIXEL", "[red, green, blue]", "Mỗi cường độ nằm từ 0 đến 255.")}</div>` },
    { tab: "Đổi số", title: "Đổi một bộ ba làm đúng một pixel đổi màu", lead: "`image[2][3]` chỉ đúng pixel ở hàng 2, cột 3. Gán `(255,255,0)` biến ô đó thành vàng mà không thay các ô khác.", visual: `<div class="vl-two">${formula("GÁN PIXEL", "image[2][3] = (255,255,0)", "Hàng viết trước, cột viết sau.")}${matrix([["B","B","B","B"],["R","R","R","R"],["R","Y","R","R"],["R","R","R","R"]],{label:"MỘT Ô ĐÃ ĐỔI",highlight:[[2,1]]})}</div>` },
    { tab: "Project", title: "Đổi cả vùng màu bằng vòng lặp", lead: "Sửa một pixel thành vàng, rồi duyệt toàn ảnh và đổi 15 pixel còn bằng RED thành ORANGE. Nền xanh phải giữ nguyên.", visual: brief([["ĐÃ CHO", "hình chữ nhật RGB 6×8"], ["ĐỔI MỘT Ô", "hàng 2, cột 3 thành vàng"], ["ĐỔI MỘT VÙNG", "RED → ORANGE"], ["BẰNG CHỨNG", "15 cam · 32 nền · shape 6×8×3"]]) },
  ],
  kernel: [
  ...
  capstone: [
    ...
    { tab: "Project", title: "Trạm săn ấn cổ và thử thách hướng bàn tay", lead: "Ghép grayscale, blur, ZNCC, threshold và NMS trên ba frame; sau đó dùng vector bàn tay, `atan2` và ánh xạ ngược để chuẩn bị cho livestream xoay theo tay.", visual: brief([["ĐÃ CHO", "3 frame RGB nhỏ · 1 template"], ["PIPELINE", "gray → blur → ZNCC → NMS"], ["BÁO CÁO", "box · track · confidence"], ["TỐI THƯỢNG", "wrist → angle → inverse map"]]) },
  ],
});
